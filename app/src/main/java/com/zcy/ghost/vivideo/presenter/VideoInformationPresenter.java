 ...
 */
public class VideoInformationPresenter extends RxPresenter implements VideoInformationContract.Presenter {
    ...
    @NonNull
    final VideoInformationContract.View mView;

    public VideoInformationPresenter(@NonNull VideoInformationContract.View addTaskView, VideoInfo videoInfo) {
