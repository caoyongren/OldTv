...
public class SearchSuggestionsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public SearchSuggestionsAdapter(Context context, int suggestionTextSize,int suggestionTextColor, Listener listener) {
        this.mContext = context;
        this.mListener = listener;
        this.mBodyTextSizePx = suggestionTextSize;
        this.mBodyTextColor = suggestionTextColor;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        viewHolder.body.setTextColor(mBodyTextColor);
        return viewHolder;
    }
