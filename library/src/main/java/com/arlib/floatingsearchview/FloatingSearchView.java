...
public class FloatingSearchView extends FrameLayout {
    ...
    private int mSuggestionsTextColor;
    ...
    private void applyXmlAttributes(AttributeSet attrs) {
        ...
        try {
            ...
            setSuggestionItemTextColor(a.getColor(R.styleable.FloatingSearchView_floatingSearch_suggestionItemTextViewColor,Util.getColor(getContext(), R.color.black)));
    ...
    private void setSuggestionItemTextColor(int color) {
        this.mSuggestionsTextColor = color;
    }
    /**
    ...
    private void setupSuggestionSection() {
        ...
        mSuggestionsAdapter = new SearchSuggestionsAdapter(getContext(), mSuggestionsTextSizePx,mSuggestionsTextColor,
    ...
    public void onRestoreInstanceState(Parcelable state) {
        ...
        setSuggestionItemTextColor(savedState.suggestionItemTextColor);
    ...
    static class SavedState extends BaseSavedState {
        ...
        private int suggestionItemTextColor;
